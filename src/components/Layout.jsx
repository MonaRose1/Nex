...
const Layout = ({ children }) => {
    return (
        <div className="relative min-h-screen text-white overflow-x-hidden font-inter selection:bg-brightTeal selection:text-white">
            {/* Background Image */}
            ...
            <div className="relative z-10 flex flex-col">
                <Navbar />
                <main className="flex-grow flex flex-col items-center w-full max-w-[1600px] mx-auto px-6 sm:px-12">
                    {children}
                </main>
                <Sidebar />
            </div>
